      ...
      <div className="teacherInfo">
        ...
        <div className="teacherBio">
          ...
          <p>
            ...
            quae, aut velit laborum iste autem, sequi saepe perspiciatis nobis
            omnis repudiandae quas possimus at neque quis assumenda quibusdam
            voluptatum nulla!
          </p>
        </div>
      </div>
      <Button type="button" buttonVariation="defaultRound">
        Mostrar mais
      </Button>
    </StyledTeacherCard>
  );
